...
new JSXBlock('generictext'); 
new JSXBlock('slideshow', true);
new JSXBlock('slide', true, ['themeimagepath' => get_theme_file_uri('/images/')]);


// function myallowedblocks($allowed_block_types, $editor_context) {
  // restrict a certain block types
  // if ($editor_context->post->post_type == 'professor' ) {
  //  return array("ourblocktheme/header", "ourblocktheme/footer");
  // }

  //  if you are one a page/post editor screen
  // if(!empty($editor_context->post)) {
  //   return $allowed_block_types;
  // } 

  // if you are one the full site editor screen
  // return array("ourblocktheme/header" , "ourblocktheme/footer");

// }

// 
// add_filter( 'allowed_block_types_all', 'myallowedblocks', 25, 2 );